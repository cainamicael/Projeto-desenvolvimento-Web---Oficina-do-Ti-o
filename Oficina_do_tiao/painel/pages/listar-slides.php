<?php
	if(isset($_GET['excluir'])){
		...
		$selectImagem = MySql::conectar()->prepare("SELECT imagem FROM `tb_site.slides` WHERE id = ?");
...
<div class="box-content">
	...
	<table>
		...
		<tr>
			...
			<td>
                <img style="width: 65px; height: 50px;"src="<?php echo INCLUDE_PATH_PAINEL?>uploads/<?php echo $value['imagem']?>">
            </td>
